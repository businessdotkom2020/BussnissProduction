        ...
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                tpl: {
                    ...
                    message: '<div class="card-text file-upload-message"><i class="fa fa-camera"></i><p>{{ default }}</p></div>',
                    ...
                    clearButton: '<button type="button" class="btn btn-sm btn-danger">{{ remove }}<i class="fa fa-trash"></i></button>',
