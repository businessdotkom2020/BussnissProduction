...
@section('backend-main')
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{ __('dashboard.edit') }} {{ __('dashboard.service') }} " {{ $service->name }} "</h4>
                    <p class="card-title-desc"></p>
                    <form method="post" action="{{ route('servicess.update' , $service->id) }}" class="needs-validation" novalidate
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="user_id" class="form-control select2" required>
                                        @foreach($users as $user)
                                            <option
                                                    @if($user->id == $service->user_id) selected @endif
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" id="validationCustom02"
                                           placeholder="{{ __('dashboard.title') }}" value="{{ $user->name }}" required>
                                    @error('name')
