            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div style="display: flex;justify-content: space-between;">
                        ...
                        <button style="margin-bottom: 10px" class="btn btn-danger delete_all" data-url="{{ url('admin/delete_requestss') }}">{{ __('dashboard.delete_all') }}</button>
                    </div>
                    <hr>
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        @foreach($requests as $req)
                            <tr id="tr_{{$req->id}}">
                                <td><input type="checkbox" class="sub_chk" data-id="{{$req->id}}"></td>
