            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div style="display: flex;justify-content: space-between;">
                        <a href="{{ route('productss.create') }}" class="btn btn-success mb-2"><i class="mdi mdi-plus mr-2"></i> Add
                            New</a>
                        <a class="btn btn-danger mb-2  delete-all text-white" onclick="return false;"
                           delete_url="/delete_productss/"><i class="mdi mdi-trash-can-outline mr-2"></i>Delete All</a>
                    </div>
                    <hr>
                        ...
                        @foreach($products as $product)
                            <tr>
                                ...
                                <td>
                                    ...
                                    /
                                    {{ implode(' ', array_slice(explode(' ', $product->getTranslatedAttribute('name','ar')), 0, 5)) }}
                                </td>
