            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div style="display: flex;justify-content: space-between;">
                        <a href="{{ route('subsubcategories.create') }}" class="btn btn-success mb-2"><i class="mdi mdi-plus mr-2"></i> {{ __('dashboard.add_new') }}</a>
                        <button style="margin-bottom: 10px" class="btn btn-danger delete_all" data-url="{{ url('admin/delete_subsubcategories') }}">{{ __('dashboard.delete_all') }}</button>
