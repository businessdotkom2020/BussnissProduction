                        ...
                        <div class="i-footer col-xs-12">
                            ...
                            <div class="extra">
                                ...
                                <div class="prod-extra">
                                    <a href="javascript:void(0)" id="fav-{{$service->id}}"
                                        class="{{$service->isFavorited() ? 'fav-active' : null  }}"
                                        onclick="favtoggle({{$service->id }},{{Auth::user() ? Auth::user()->id : null}})">
                                ...
                                <a class="btn" href="{{url('supplier/'.$service->user_id)}}"
