            ...
            <div class="container">
                ...
                <div class="header-right">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-box">
                            <a href="#ENG">
                                <img src="https://portotheme.com/html/wolmart/assets/images/flags/eng.png"
                                    alt="ENG Flag" width="14" height="8" class="dropdown-image">
                                ENG
                            </a>
                            <a href="#FRA">
                                <img src="https://portotheme.com/html/wolmart/assets/images/flags/fra.png"
                    ...
                    <div class="main-content">
                        ...
                        <div class="tab tab-nav-boxed tab-nav-underline">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#tab2-3">Branches</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#tab2-4">About</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab2-2">
                                    <p class="mb-0">Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi
                                        neque, aliquet
                                        ...
                                        <div class="store-wrap mb-4">
                                            <div class="store store-grid">
                                                ...
                                                <div class="store-footer">
                                                    <figure class="seller-brand">
                                                        <img src="assets/images/vendor/brand/1.jpg" alt="Brand"
                                                            width="80" height="80">
                                                    </figure>
