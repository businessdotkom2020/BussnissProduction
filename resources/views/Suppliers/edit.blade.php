            ...
            <div class="tab-content col-md-9 col-xs-12">
                ...
                <div class="tab-pane fade active in" id="t4">
                    <form action="{{route('update_supplier')}}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="s-item col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="prof-img">
                                     <label>
                                         ...
                                         <img src="{{url('storage/'.$supplier->store_background)}}" id="blah" alt="your image">
                                     </label>
                             </div>
                        ...
                        <div class="s-item col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="prof-img">
                                     <label>
                                         ...
                                         <img src="{{url('storage/'.$supplier->store_image)}}" id="blah1" alt="your image">
                                     </label>
                             </div>
                        ...
                        <div class="ito-h col-xs-12">
                            ...
                            <input type="text" required name="supplier_name" value="{{$supplier->name}}" placeholder="@lang('general.supplier_name')" class="form-control">
                        </div>

                        <div class="form-group col-md-6 col-xs-12">
                            <select style="width:100%" required name="category_ids[]" class="form-control select-nosearch" multiple>
                                <!--<option selected disabled>@lang('general.categories')</option>-->
                                @foreach(\App\Models\Category::whereNull('parent_id')->get() as $category)

                                <option {{in_array($category->id,$supplier->categories->pluck('id')->toArray()) ? 'selected' : '' }} value="{{$category->id}}">{{$category->getTranslatedAttribute('name',\App::getLocale())}}</option>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            <input type="email" required name="email" value="{{$supplier->email}}" placeholder="@lang('general.email')" class="form-control">
                        </div>
                        <div class="form-group col-md-6 col-xs-12">
                            <input type="text" required name="mobile" value="{{$supplier->mobile}}" placeholder="@lang('general.mobile')" class="form-control">
                        </div>
                        <div class="form-group col-md-12 col-xs-12">
                            <input type="text" required name="hot_number" value="{{$supplier->hot_number}}" placeholder="@lang('general.hot_line')" class="form-control">
                        </div>
                        ...
                        <div class="ito-h col-xs-12">
                            <h4>@lang('general.localization_info')</h4></h4>
                        ...
                        <div class="form-group col-md-4 col-xs-12">
                            ...
                            <select style="width:100%" required name="state_id"  id="state" class="form-control">
                                ...
                                <option  {{ $supplier->state_id == $state->id ? 'selected' : ''}} value="{{$state->id}}">{{$state->name}}</option>
                                @endforeach
                        ...
                        <div class="form-group col-md-4 col-xs-12">
                            ...
                            <select style="width:100%" required name="city_id"  id="city" class="form-control">
                                ...
                                <option  {{ $supplier->city_id == $city->id ? 'selected' : ''}} value="{{$city->id}}">{{$city->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group col-md-12 col-xs-12">
                        ...
                        <h4>@lang('general.working_from')</h4>
                            ...
                            <input required type="text" name="working_from" placeholder="@lang('general.working_from')" class="form-control">
                        </div>

                            <div class="form-group col-md-6 col-xs-12">
                                <h4>@lang('general.working_to')</h4>

                            <input required type="text" name="working_to" placeholder="@lang('general.working_to')" class="form-control">
                        </div>
                            ...
                            <input required type="text" name="delivery_time" placeholder="@lang('general.delivery_time')" class="form-control">
                        </div>
                            ...
                            <input required type="text" name="delivery_fee" placeholder="@lang('general.delivery_fee')" class="form-control">
                        </div>

                        <div class="form-group col-md-6 col-xs-12">
                                <h4>@lang('general.year_founded')</h4>

                            <input required type="text" name="year_founded" placeholder="@lang('general.year_founded')" class="form-control">
                        </div>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <input required type="text" name="instagram_url" placeholder="@lang('general.instagram_url')" class="form-control">
                        </div>
                        <div class="form-group col-md-6 col-xs-12">
                                <h4>@lang('general.facebook_url')</h4>

                            <input required type="text" name="facebook_url" placeholder="@lang('general.facebook_url')" class="form-control">
                        </div>
                        <div class="form-group col-md-6 col-xs-12">
                                <h4>@lang('general.linkedin_url')</h4>

                            <input required type="text" name="linkedin_url" placeholder="@lang('general.linkedin_url')" class="form-control">
                        </div>
                        <div class="form-group col-md-6 col-xs-12">
                                <h4>@lang('general.youtube_url')</h4>

                            <input required type="text" name="youtube_url" placeholder="@lang('general.youtube_url')" class="form-control">
                        </div>
                ...
                <form action="{{route('update_password')}}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <input required type="password" name="old_password" placeholder="@lang('general.old_password')" class="form-control">
                        </div>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <input required type="password" name="password" placeholder="@lang('general.password')" class="form-control">
                        </div>
                        ...
                        <div class="form-group col-md-6 col-xs-12">
                            ...
                            <input required type="password" name="password_confirmation" placeholder="@lang('general.password_confirmation')" class="form-control">
                        </div>
