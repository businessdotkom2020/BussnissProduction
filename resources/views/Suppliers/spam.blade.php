                                                ...
                                                <div class="store-content ">
                                                    <div class="store-data-container">
                                                        ...
                                                        <div class="store-data">
                                                            <h2><a href="logancee3.html">Global Office</a></h2>
                                                            <div class="dokan-seller-rating"
                                                                title="Rated 3.64 out of 5">
                                                                <i class="dashicons dashicons-star-filled"></i><i
                                                            ...
                                                            <p class="store-address"><span class="street_1"> 325 Orchard
                                                                    Str,</span><br><span class="country"> South Korea
                                                                </span></p>
                                                            <p class="store-phone">
                                                                <i class="fa fa-phone" aria-hidden="true"></i> (+053)
                                                                77-637-3300
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="store-footer">
                                                    <div class="seller-avatar">
                                                        ...
                                                        <noscript><img alt=""
                                                                ...
                                                                height="150" src="images/12-vendor-150x150.jpg"
                                                                width="150"></noscript>
                                                    </div>
                                                ...
                                                <div class="store-content default-store-banner">
                                                    <div class="store-data-container">
                                                        ...
                                                        <div class="store-data">
                                                            ...
                                                            <p class="store-address"><span class="street_1"> 335
                                                                    Orchard,</span><br><span class="country"> Singapore
                                                                </span></p>
                                                            <p class="store-phone">
                                                                <i class="fa fa-phone" aria-hidden="true"></i> (+033)
                                                                77-637-3300
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="store-footer">
                                                    <div class="seller-avatar">
                                                        <img alt=""
                                                            ...
                                                            class="avatar avatar-150 photo lazyloaded" height="150"
                                                            width="150"
                                            ...
                                            <div class="store-wrapper">
                                                ...
                                                <div class="store-content default-store-banner">
                                                    <div class="store-data-container">
                                                        ...
                                                        <div class="store-data">
                                                            <h2><a href="iclever.html">Robert’s Store</a></h2>
                                                            <div class="dokan-seller-rating"
                                                            ...
                                                            <p class="store-address"><span class="street_1"> 325
                                                                    Orchard,</span><br><span class="state"> Buenos
                                                                    Aires,</span><span class="country"> Argentina
                                                                </span></p>
                                                            <p class="store-phone">
                                                                <i class="fa fa-phone" aria-hidden="true"></i> (+093)
                                                                77-637-3300
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="store-content ">
                                                    <div class="store-data-container">
                                                        ...
                                                        <div class="store-data">
                                                            ...
                                                            <p class="store-address"><span class="street_1"> 326 Orchard
                                                                    Str,</span><br><span class="state">
                                                                    Riau,</span><span class="country"> Indonesia </span>
                                                            </p>
                                                            <p class="store-phone">
                                                                <i class="fa fa-phone" aria-hidden="true"></i> (+043)
                                                                88-637-3300
                                                            </p>
                                                        </div>
                                                    </div>
