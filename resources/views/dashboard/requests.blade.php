        ...
        <div class="jumpo col-xs-12" style="background-image: url(https://businessdotkom.com/web/images/cover.jpg)">
            <div class="container">
                       ...
                       @foreach(\App\Models\Request::where('user_id',\Auth::id())->get() as $request)
                        ...
                        <div class="inner">
                            <div class="i-img">
                                ...
                                <a href="{{url('request/'.$request->id.'/delete')}}" style="left: auto;right: 10px;" class="fav-pro">
                ...
                @endif
                            ...
                            <div class="i-data">
                                <a href="{{url('request/'.$request->id)}}" class="title">{{$request->getTranslatedAttribute('name',\App::getLocale())}}</a>
