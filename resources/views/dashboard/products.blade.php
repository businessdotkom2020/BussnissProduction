...
@section('content')
 <div class="overlay-s"></div>
        <div class="jumpo col-xs-12" style="background-image: url(http://businessdotkom.com/web/images/cover.jpg)">
            <div class="container">
                <h3>Products</h3>
                <ul>
                    <li>
                ...
                <div class="container">
                      ...
                      <div class="form-group col-md-12 col-xs-12" style="text-align: center;margin-top: 15px;">
                            <button  onclick="window.location='{{ url('products/new') }}'"  type="submit" class="btn">Add Product <i class="fa fa-plus"></i></button>
                        </div>
        <br>
        <br>
        <br>
        ...
        <br>
              ...
              <a href="javascript:void(0)" id="fav-{{$product->id}}" class="fav-{{$product->id}} fav-pro {{$product->isFavorited() ? 'fav-active' : null  }}"  onclick="favtoggle({{$product->id }},{{Auth::user() ? Auth::user()->id : null}})">
                                ...
                                <a href="{{url('product/'.$product->id.'/delete')}}" style="left: auto;right: 10px;margin-top: 50px;" class="fav-pro">
